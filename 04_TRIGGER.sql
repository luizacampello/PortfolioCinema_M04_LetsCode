...
BEGIN
	...
	IF @command = 'Insert'
		INSERT INTO ScoreLogs (command, data_log, username, next_idPortfolio, next_cpf, next_idMovie, next_score)
		SELECT @command, GETDATE(), USER_NAME(), ins.id_portfolio, ins.cpf, ins.id_movie, ins.score
		FROM inserted AS ins
	ELSE IF @command = 'Delete'
		INSERT INTO ScoreLogs (command, data_log, username, previous_idPortfolio, previous_cpf, previous_idMovie, 
		previous_score)
